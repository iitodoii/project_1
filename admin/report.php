    ...
    <div class="row">
        ...
        <form method="GET" id="form" action="">
			<div style="float:left;" id="hid">    
				วันที่เริ่มต้น : <input type="date" class="btn btn-default" size="20" name="d_s" id="date" value="" >
                วันที่สิ้นสุด : <input type="date" class="btn btn-default" size="20" name="d_e" id="date01" value="" >
				<button class="btn btn-default" id="submit" name="bt_search" >ค้นหา</button>
			</div>	
        </form><br><br><br>
        <div class="card" style="width: auto;">
            <div class="col-sm-12">

                <table id="example" class="display table table-hover" align="center" width="100%">
                    <thead>
