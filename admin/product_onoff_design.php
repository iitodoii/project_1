...
//$p_id = $_GET['p_id'];
                ...
                if(isset($_GET['product_id'])){
                    $query2 = "UPDATE product_design SET design_stu = 'ปิดการใช้งาน' 
                    WHERE design_id = ".$_GET['product_id']."  ";
               ...
               elseif(isset($_GET['p_id'])) {
                    $query3 = "UPDATE product_design SET design_stu = 'เปิดการใช้งาน' 
                    WHERE design_id = ".$_GET['p_id']."  ";
