...
$sql = "SELECT SUM(A.price*A.quantity) total,A.product_id,B.product_name,SUM(A.quantity) count FROM `purchase_detail` A JOIN product B ON A.product_id = B.product_id GROUP BY product_id,B.product_name ORDER BY total DESC;";
