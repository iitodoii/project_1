...
$sql = "SELECT * FROM `purchase` order by stu asc";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12" style="overflow-x:auto">
                        <h4 class="mr-4 mt-4">รายงานข้อมูลการแจ้งชำระเงิน วัน/เดือน/ปี</h4>
                        <table id="report3" class="table table-bordered table-hover" style="overflow-x:auto">
                            <thead class="bg-dark text-white">
                                <th>รหัสคำสั่งซื้อ</th>
                                <th>ชื่อผู้สั่งซื้อ</th>
                                <th>วันที่</th>
                                <th class="d-none">รหัสการชำระเงิน</th>
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result1)) {
                                    ...
                                    if ($row['stu'] == 0) {
                                        echo "<td>ยังไม่ได้ชำระเงิน</td>"; //ยอดรวมราคาของออเดอร์
                                    } else if ($row['stu'] <= 2) {
                                        echo "<td>ตรวจสอบการชำระเงิน</td>"; //ยอดรวมราคาของออเดอร์
                                    } else {
                                        echo "<td>ชำระเงินแล้ว</td>"; //ยอดรวมราคาของออเดอร์
                                    }
...
<script type="text/javascript">
    $(document).ready(function() {
        var table2 = $('#report3').DataTable({
            ...
            // "overflow": true,
            "order": [
                [3, 'asc'] // 'none' indicates no initial sorting for the first column
            ],
