...
<body>
    ...
    <div class="col-md-12">
    <a href="index_admin.php?p=pro" class="pull-right btn btn-warning"><span class="glyphicon glyphicon-plus"></span> สินค้าทั้งหมด</a>
	...
	<h4 class="page-header">รายการสินค้าขายดี 5 ชื้น</h4>
...
<caption><h1>รายการสินค้าขายดี 5 ชื้น</h1></caption>
    <thead>
        <tr>
            <th width="7%">#</th>
            <th width="15%">รูป</th>
            ...
            GROUP BY purchase_detail.product_id order by product.category_id asc, product_name asc LIMIT 0 , 5";
