...
$sql = "SELECT a.*,b.category_name FROM `product` a JOIN category b on a.category_id = b.category_id";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12" style="overflow-x:auto">
                        <h4 class="mr-4 mt-4">รายงานข้อมูลสินค้า (ตามประเภท)</h4>
                        <table id="report3" class="table table-bordered table-hover" style="overflow-x:auto">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result1)) {
                                    ...
                                    echo "<td> {$row['product_name']} </td>"; //ชื่อออเดอร์ ชื่อผู้รับสินค้า
                                    echo "<td> {$row['category_name']} </td>"; //ยอดรวมราคาของออเดอร์
                                    echo "<td> {$row['price']} </td>"; //ยอดรวมราคาของออเดอร์
