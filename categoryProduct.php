...
<body style="background-color: #fce4ec">
    ...
    <div class="p-5 m-0">
        ...
        <p class="text-muted fs-4"><a href="index.php">สินค้า</a>/สินค้าตามหมวดหมู่</p>
        ...
        <div class="row">
            <div class="container">
                <div class="row">
                    ...
                    $where = " WHERE product_name LIKE '%" . $q . "%' AND product_status ='เปิดการใช้งาน' AND category.category_id = '".$cat_id."'";
