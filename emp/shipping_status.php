		...
		<div class="row">
			<div class="col-md-12">
				<div class="card" style="width: auto;"><br>
					<h1 class="page-header text-center ">รายการสถานะการจัดส่ง</h1>
                ...
                ";
							...
							?>
								<tr>
									...
									?>
									<td class="text-right">
										<div class="y"> <?php echo $transport ?></div>
									</td>
									<td class="text-right">
									...
									<td class="text-center">
										<div class="y">
											<?php if ($row['stu'] == 1) {
												echo '<a href=""  class="btn btn-primary btn-sm">รอชำระเงิน</a>';
											} else if ($row['stu'] == 2) {
												echo '<a href=""  class="btn btn-info btn-sm">รอจัดส่ง</a>';
											} elseif ($row['stu'] > 2) {
