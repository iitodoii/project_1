  ...
  <div class="container px-4">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4 justify-content-between">
        ...
        <li class="nav-item"><a class="nav-link text-dack" href="fullproduct.php">สินค้าทั้งหมด</a></li>
      ...
      <form class="form-inline">
        <a class="btn text-white" type="submit" href="emp/updatecart.php" style="background-color: #ad1457">
