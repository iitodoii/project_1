...
<body style="background-color: #fce4ec">
    ...
    <div class="p-5 m-0">
        ...
        <h1>สินค้าตามหมวดหมู่</h1>
        <div class="row">
            <div class="col-md-3">
                <a class="card card-outline cursor-p" href="categoryProduct.php?cat_id=11">
                    <div class="card-header text-center">
                        <h5 class="card-title">ชุดเดรส</h5>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <img src="image/p3.jpg" height="300" width="100%">
                    </div>
                    <!-- /.card-body -->
                </a>
                <!-- /.card -->
            ...
            <div class="col-md-3">
                <a class="card card-outline cursor-p" href="categoryProduct.php?cat_id=13">
                    <div class="card-header text-center">
                        <h5 class="card-title">เสื้อผ้าเด็ก</h5>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <img src="image/kid1.png" height="300" width="100%">
                    </div>
                    <!-- /.card-body -->
                </a>
                <!-- /.card -->
            ...
            <div class="col-md-3">
                <a class="card card-outline cursor-p" href="categoryProduct.php?cat_id=12">
                    <div class="card-header text-center">
                        <h5 class="card-title">เสื้อผ้าผู้หญิง</h5>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <img src="image/p6.jpg" height="300" width="100%">
                    </div>
                    <!-- /.card-body -->
                </a>
                <!-- /.card -->
            ...
            <div class="col-md-3">
                <a class="card card-outline cursor-p" href="categoryProduct.php?cat_id=14">
                    <div class="card-header text-center">
                        <h5 class="card-title">เสื้อผ้าผู้ชาย</h5>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <img src="image/a13.jpg" height="300" width="100%">
                    </div>
                    <!-- /.card-body -->
                </a>
                <!-- /.card -->
        ...
        <div class="row">
            <div class="container">
                <div class="row">
                    ...
                    $sql1 = "select * from product join category on product.category_id = category.category_id ";
                    $where = " WHERE product_name LIKE '%" . $q . "%' AND product_status ='เปิดการใช้งาน'  ORDER BY RAND() LIMIT 8;";
                                ...
                                <div class="card-footer p-1 pt-0 border-top-0 bg-transparent">
                                    ...
                                    <?php } else { ?>
                                        <?php if ($row1['num'] < 1) { ?>
                                            <div class="text-center"> <a class="btn mt-auto btn-secondary"><i class="fa-solid fa-circle-exclamation"></i> สินค้าหมด</a></div>
                                        <?php } else { ?>
                                            <div class="text-center"> <a class="btn mt-auto text-white" href="emp/addcart.php?ID=<?php echo $row1['product_id']; ?>&REC=<?php echo $row1['recommended']; ?>" style="background-color: #ec407a;"><i class="bi-cart-fill me-1"></i> สั่งซื้อ</a></div>
                                    <?php }
                                    } ?>
                                </div>
                            </div>
